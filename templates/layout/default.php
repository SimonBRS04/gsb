...
<body>
    <nav class="top-nav">
        ...
        <?php
        echo $this->Html->Link('FichesList (Usr)', ['plugin' => NULL, 'controller'=>'fiches', 'action'=>'myficheslist']);
        echo $this->Html->Link('FichesView (Usr)', ['plugin' => NULL, 'controller'=>'fiches', 'action'=>'myfichesview']);
