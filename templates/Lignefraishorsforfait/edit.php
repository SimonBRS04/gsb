...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $lignefraishorsforfait->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $lignefraishorsforfait->id), 'class' => 'side-nav-item']
            ) ?>
    ...
    <div class="column-responsive column-80">
        <div class="lignefraishorsforfait form content">
            ...
            <fieldset>
                <legend><?= __('Edit Lignefraishorsforfait') ?></legend>
                <?php
